...
public class KillPlayer : MonoBehaviour
{
    ...
    void Update()
    {
        if (Time.timeScale == 0.3f && seconds >= 1)
        {
            Time.timeScale = 1f;
        ...
        else if (Time.timeScale == 0.3f && seconds < 1)
        {
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(KillPlayer original)
        {
            ...
            var KillPlayer = GameObject.AddComponent<KillPlayer>();
            KillPlayer.CutCascades = original.CutCascades;
            KillPlayer.ExplodeForce = original.ExplodeForce;
